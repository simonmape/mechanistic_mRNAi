...
dataset = MechanisticModelDataset(csv_file="mock_training_data2.csv", root_dir="/data/math-multicellular-struct-devel/hert6124/pakman-develop/examples/DeepScratch/datadir3")
