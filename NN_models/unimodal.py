...
class ConditionalAutoEncoder(pl.LightningModule):
    ...
    def reshape_r1(self,r1_output):
        r1_means,r1_stds = r1_output.split((10,10),dim=1)
        t = nn.Tanh()
        r1_means = t(r1_means)
        r = nn.ReLU()
        safety = torch.ones(10).new_full((10,),0.0001)
    ...
    def forward(self,batch):
        ...
        r1_means,r1_stds = self.reshape_r1(self.r1(data_flat))
    ...
    def training_step(self, batch, batch_idx):
        ...
        print(self.schedule[batch_idx]*KL_term.mean(),log_term.mean())       
